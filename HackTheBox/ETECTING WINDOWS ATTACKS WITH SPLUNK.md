...
Counts thenumber of events per process (proc).
...
Assign arbitrary user as domain admin using tools likeMimikatz.
...
Attacker needsone valid user account in the domain.
...
Focus onquery length andfrequency per host.
